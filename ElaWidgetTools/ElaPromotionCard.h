...
class ELA_EXPORT ElaPromotionCard : public QWidget
{
    ...
    Q_PROPERTY_REF_CREATE_Q_H(QColor, CardTitleColor)
    Q_PROPERTY_REF_CREATE_Q_H(QColor, PromotionTitleColor)
    Q_PROPERTY_REF_CREATE_Q_H(QColor, PromotionTitleBaseColor)
    Q_PROPERTY_REF_CREATE_Q_H(QColor, TitleColor)
    Q_PROPERTY_REF_CREATE_Q_H(QColor, SubTitleColor)
