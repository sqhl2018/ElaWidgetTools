#ifndef ELAWORKSPACE_ELAWIDGETTOOLS_ELAPROGRESSRING_H_
#define ELAWORKSPACE_ELAWIDGETTOOLS_ELAPROGRESSRING_H_
...
#endif //ELAWORKSPACE_ELAWIDGETTOOLS_ELAPROGRESSRING_H_
