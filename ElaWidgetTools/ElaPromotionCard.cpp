...
Q_PROPERTY_REF_CREATE_Q_CPP(ElaPromotionCard, QString, SubTitle)
Q_PROPERTY_REF_CREATE_Q_CPP(ElaPromotionCard, QColor, CardTitleColor)
Q_PROPERTY_REF_CREATE_Q_CPP(ElaPromotionCard, QColor, PromotionTitleColor)
Q_PROPERTY_REF_CREATE_Q_CPP(ElaPromotionCard, QColor, PromotionTitleBaseColor)
Q_PROPERTY_REF_CREATE_Q_CPP(ElaPromotionCard, QColor, TitleColor)
Q_PROPERTY_REF_CREATE_Q_CPP(ElaPromotionCard, QColor, SubTitleColor)
